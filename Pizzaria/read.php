...
<div class="content read">
    ...
    <h2>Filtre seus Pedidos</h2>
    <a href="readPizza.php" class="content-read">Filtrar pelo Cliente</a>
    <a href="readSabor.php" class="content-read">Filtrar pelo Sabor</a>
    <a href="readData.php" class="content-read">Filtrar pela Data</a>
